    ...
    <div class="col-md-12">
        ...
        <div class="container">
            <div class="blog-title"> 
                <h2>
                    <?=$this->Html->link('CakePHP Blog', array('controller' => 'posts', 'action' => 'index'));?>
                </h2>
            ...
            <div class="row form-group">
                <div class="col-md-8">               
                    ...
                    <div class="col-md-4">
                        <div class="panel">
                            <div class="panel-heading panel-sidebar">                            
                          ...
                          <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="home">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="sidebar-popular" style="margin-top: 10px;">                            

                                        <div class="media">
                                          <a class="pull-left" href="posts/view/<?=$post['Post']['id']?>">
                                            <div class="post-image-sidebar">                        
                                                <?= $this->Html->image('/files/Post/img/' . $recent['Post']['img_dir'] . '/' . $recent['Post']['img']) ?>

                                            </div>
                                        </a>
                                        <div class="media-body">
                                            <h4>
                                                <?= $this->Html->link($recent['Post']['title'], array('controller' => 'posts', 'action' => 'view', $recent['Post']['id'])); ?>
                                            </h4>

                                            <span class="label sidebar-date"><?= $this->Time->format('M j, Y', $recent['Post']['created']);?></span> 
                                        </div>
                                    </div>
                                </li>
                                <?php } ?>
